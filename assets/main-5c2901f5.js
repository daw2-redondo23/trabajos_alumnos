...
const enableDismissTrigger = (component, method = "hide") => {
  ...
  EventHandler.on(document, clickEvent, `[data-bs-dismiss="${name2}"]`, function(event2) {
...
class Serializer {
  ...
  _decodeBroadcast(buffer, view, decoder) {
    ...
    const event2 = decoder.decode(buffer.slice(offset2, offset2 + eventSize));
...
class GoTrueClient {
  ...
  constructor(options) {
    ...
    if (isBrowser() && globalThis.BroadcastChannel && this.persistSession && this.storageKey) {
      ...
      this.broadcastChannel.addEventListener("message", (event2) => {
...
class SupabaseClient {
  ...
  _handleTokenChanged(event2, token, source) {
    ...
    } else if (event2 === "SIGNED_OUT" || event2 === "USER_DELETED") {
