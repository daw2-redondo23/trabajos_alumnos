...
const proyectosVista = {
  ...
  script: async () => {
    ...
    try {
      ...
      <tr>
        <td>
          <img src="assets/proyecto.png" width="100" alt="" data-id="${proyecto.id}" class="detalle"/>
        </td>
        ...
        <td class="text-end">
          ...
          >
          <img  data-id="${proyecto.id}" class="detalle w-50" src="assets/icons8-acerca-de.svg" width="20" alt="" />
          </button>
          <button
            data-id="${proyecto.id}"
            type="button"
