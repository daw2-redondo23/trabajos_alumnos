    ...
    script: async () => {
      ...
      <tr>
        ...
        <td class="text-end">
          ...
          >
          <img  data-id="${proyecto.id}" class="detalle w-50" src="/assets/iconos/icons8-acerca-de.svg" width="20" alt="" />
          </button>
          <button
            data-id="${proyecto.id}"
            type="button"
          ...
          >
            <img data-id="${proyecto.id}" class="editar w-50" src="/assets/iconos/icons8-editar.svg" width="20" alt="" />
          </button>
          ...
          >
            <img data-id="${proyecto.id}" class="borrar w-75" src="/assets/iconos/icons8-basura-llena.svg" width="20" alt=""/>
          </button>
        </td>
      </tr>
      `
